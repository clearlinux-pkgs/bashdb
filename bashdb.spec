...
%prep
%setup -q -n bashdb-5.0-1.1.2
cd %{_builddir}/bashdb-5.0-1.1.2
...
cp %{_builddir}/bashdb-5.0-1.1.2/command/show_sub/copying.sh %{buildroot}/usr/share/package-licenses/bashdb/52da88f0dbc63b238773202dded383bd8c0b3421
%make_install
...
/usr/share/bashdb/set-d-vars.sh
