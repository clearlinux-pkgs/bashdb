...
Source0  : https://sourceforge.net/projects/bashdb/files/bashdb/5.0-1.1.1/bashdb-5.0-1.1.1.tar.gz
...
%prep
%setup -q -n bashdb-5.0-1.1.1
cd %{_builddir}/bashdb-5.0-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575785376
...
cp %{_builddir}/bashdb-5.0-1.1.1/COPYING %{buildroot}/usr/share/package-licenses/bashdb/74a8a6531a42e124df07ab5599aad63870fa0bd4
cp %{_builddir}/bashdb-5.0-1.1.1/command/show_sub/copying.sh %{buildroot}/usr/share/package-licenses/bashdb/52da88f0dbc63b238773202dded383bd8c0b3421
%make_install
